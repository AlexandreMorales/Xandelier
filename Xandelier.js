    ...
    */
    ...
    Parametros:
        content: (Objeto) Objeto com as configurações do Elemento:
            ...
            Para adicionar multiplos eventos o nome do atributo deve ser 'addEventListener' e o conteúdo deve ser o nome do evento como atributo e a função do evento como conteúdo;
            Para adicionar um estilo o nome do atributo deve ser 'S' + nome_do_estilo e o conteúdo deve ser o valor do estilo;
            Para adicionar multiplos estilos o nome do atributo deve ser 'style' e o conteúdo deve ser o nome do estilo como atributo e o valor do estilo como conteúdo;
    ...
    Array.prototype.search = function(el, att){
        ...
        return this.filter(function(d){
            ...
            switch(elType){
                ...
                break;
                case "string":
                    return d.toUpperCase().indexOf(el.toUpperCase()) != -1;
                break;
            }
            return false;
        });
...
var X, Xand, Xandelier;
 X = Xand = Xandelier = (function () {
    ...
    /////////////////////////////////////////////ELEMENTS//////////////////////////////////////////////
    {
        ...
        */
        X.GetLayout = function(layoutPath, containerId, callback) {
            ...
            var _modalDelay = 5,
                ...
                toggle = function (id, content, modalConfig) {
                    ...
                    if (!document.body.hasClass("modal-open")) { //if para verificar data-toggle
                        modalConfig = modalConfig || {};
                        if (!element) return;
                        X.Show(element[(content ? "add" : "remove") + "Class"]("in"), content, modalConfig._delay || _modalDelay);
    ...
    //////////////////////////////////////////////UTILS////////////////////////////////////////////////
    {
        ...
        */
        ...
        /*
        Parametros: 
            str: (String) String com acentos;
        Retorno: (String) String enviada sem acentos;
        */
        X.RemoveDiacritics = (function(){
            /*
            ...
            */
            ...
            return (str) => str.replace(/[^\u0000-\u007E]/g, a => diacriticsMap[a] || a);
        })();
        ...
        */
        X.Factorial = n => n ? n*factorial(n-1) : 1;
    }
    return X;
})();